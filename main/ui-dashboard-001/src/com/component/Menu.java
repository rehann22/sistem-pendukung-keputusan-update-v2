...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() { 
        ...
        listMenu1.addItem(new Model_Menu("virus", "Data Alternatif", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("dna", "Data Kriteria", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("6", "Penilaian Alternatif", Model_Menu.MenuType.MENU));
        ...
        listMenu1.addItem(new Model_Menu("4", "Berita", Model_Menu.MenuType.MENU)); 
